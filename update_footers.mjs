...
const targetString = `            <div className="footer-col">
                <h3>Information</h3>
...
const replacementString = `            <div className="footer-col">
                <h3>Information</h3>
                <Link href="/privacy">Privacy Policy</Link>
                <Link href="/terms">Terms of Service</Link>
                <Link href="/guest-policy">Guest Policy</Link>
    ...
    for (const file of files) {
        ...
        if (fs.statSync(fullPath).isDirectory()) {
            ...
            if (content.includes('className="footer-col"')) {
                // Remove Windows CR if any to match exactly
                let normalizedContent = content.replace(/\r\n/g, '\n');
                let found = normalizedContent.indexOf(targetString) !== -1;
