...
file_path = r'a:\bn\src\app\booking\page.tsx'
...
logic_lines = lines[:return_idx + 1]

new_jsx = """
    <div className="min-h-screen bg-[#f8f7f4] text-[#1a1512] font-outfit pb-24 pt-32">
...
print("Updated page.tsx successfully using python.")
