...
export default function FloatingWidgets() {
  ...
  return (
    <>
      ...
      {/* Left Floating Social Stack */}
      <div className={`float-social-stack${isScrolled ? " scrolled" : ""}${isFooterVisible ? " footer-hidden" : ""}`}>
        {/* WhatsApp */}
        <a href="https://wa.me/917037794300" target="_blank" rel="noopener noreferrer" className="socialcontainer" title="Chat on WhatsApp">
        ...
        {/* Instagram */}
        <a href="https://www.instagram.com/braj.nidhi_/" target="_blank" rel="noopener noreferrer" className="socialcontainer" title="Follow us on Instagram">
        ...
        {/* Facebook */}
        <a href="#" className="socialcontainer" title="Facebook">
        ...
        {/* X / Twitter */}
        <a href="#" className="socialcontainer" title="Follow us on X">
      ...
      <div className={`premium-music-player${isFooterVisible ? " footer-hidden" : ""}`} id="musicPlayer" title="Hare Krishna Mahamantra">
